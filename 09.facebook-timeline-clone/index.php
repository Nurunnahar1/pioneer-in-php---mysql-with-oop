                ...
                <div class="modal-body">
                    ...
                    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data">
                        <div class="my-2">
                            ...
                            <input type="text" placeholder="name" name="post_user_name" class="form-control">
                        </div>
                        <div class="my-2">
                            <label for="">Auth User Photo</label>
                            <input type="file" placeholder="photo" name="post_user_photo" class="form-control">
                        </div>
                        <div class="my-2">
                        ...
                        <div class="my-2">
                            ...
                            <input type="file" placeholder="photo" name="post_photos[]" multiple class="form-control">
                        </div>
                        <div class="my-2">
